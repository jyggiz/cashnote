...
import { getPromocodes, deletePromocode } from '@/services/api'
    ...
    >
      ...
      {!loading && filtered.length === 0 && (
        <div className="flex flex-col items-center gap-3 pt-16 text-center">
          ...
          {isAdmin && <button onClick={() => navigate('/promocodes/new')} className="rounded-xl bg-teal-700 px-4 py-2 text-sm font-medium text-white">Add first promocode</button>}
        </div>
      )}
